...
with open("C:/Users/acer/Downloads/nb_tsdn.pkl", 'rb') as file:
...
st.image("C:/Users/acer/Downloads/header diabet (3).png", width=1024)
...
if selected == "Beranda":
    ...
    st.image("C:/Users/acer/Downloads/header diabet (4).png", width=1024)
    ...
    with tab1:
        ...
        st.image("C:/Users/acer/Downloads/hand-holding-blood-glucose-meter-measuring-blood-sugar-background-is-stethoscope-chart-file.jpg", width=500)
    ...
    with tab2:
        ...
        st.image("C:/Users/acer/Downloads/tipe diabet.png", width=400)
        ...
        st.image("C:/Users/acer/Downloads/tipe diabet (1).png", width=480)
        st.markdown(
            """
            <p style="text-align: justify; color:#263487; font-size: 18px ;">
    ...
    if input_method == "Masukkan Data Manual":
        ...
        st.write("Contoh format file CSV yang dapat diunggah:")
